...
namespace Project18_DashboardSuperStoreDataset
{
    public partial class Form1 : Form
    {
        ...
        SqlConnection sqlConnection = new SqlConnection("Server=DESKTOP-0AOKHL4\\SQLEXPRESS;initial catalog=Db17Project20;integrated security=true");
    ...
    private void Form1_Load(object sender, EventArgs e)
    {
      ...
      sqlConnection.Open();
      SqlCommand command6 = new SqlCommand("SELECT top(3) Country, sum(Quantity) From superstore Group By Country order by COUNT(*) desc", sqlConnection);
